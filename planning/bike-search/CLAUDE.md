# Claude Code Context: bike-search Planning

## Purpose

BMAD planning documents for the bike-search feature. Created during Phase 1 (Planning) in main repository on contrib branch.

## Directory Structure

```
planning/bike-search/
...
1. SpecKit auto-detects this planning directory: `../planning/bike-search/`
...
- **[README.md](README.md)** - Human-readable overview of bike-search planning
