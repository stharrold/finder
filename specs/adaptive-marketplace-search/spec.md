# Specification: Adaptive Marketplace Search
...
**BMAD Planning:** See `planning/adaptive-marketplace-search/` for complete requirements and architecture.
...
See: `planning/adaptive-marketplace-search/requirements.md` in main repository
